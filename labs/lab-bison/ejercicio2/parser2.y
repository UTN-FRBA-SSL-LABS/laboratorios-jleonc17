...
%union {
    int  int_val;
    char str_val[64]; /* TODO 1 — Agregar un miembro para cadenas: char str_val[64]; */
}

/* Declaración de tokens con su tipo semántico */
%token <int_val>  NUM             /* Ejemplo: NUM usa el miembro int_val */
%token <str_val> IDENT /* TODO 2 — Declarar IDENT con el tipo str_val: %token <str_val> IDENT  */
